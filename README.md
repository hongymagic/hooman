...
```sh
codex plugin marketplace add hongymagic/hooman --ref v0.1.1
...
For a standalone skill, extract `human-writing-0.1.1.zip` into `~/.agents/skills/` or your project's `.agents/skills/`. The resulting path must be `.../skills/human-writing/SKILL.md`. Invoke it as `$human-writing` or let Codex select it for a relevant writing request. [Codex skill locations](https://learn.chatgpt.com/docs/build-skills#where-codex-loads-local-skills).
...
```sh
git clone --branch v0.1.1 --depth 1 https://github.com/hongymagic/hooman.git
...
Where Skills are available, open **Plugins → Skills → Create → Upload from your computer** and upload the standalone `human-writing-0.1.1.zip`. Install it, then ask, “Use human-writing to edit this draft.” Availability depends on the account and workspace; see [Skills in ChatGPT](https://help.openai.com/en/articles/20001066).
